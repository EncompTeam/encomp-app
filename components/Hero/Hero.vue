...
<template>
  <div class="relative flex w-full flex-col items-center gap-6">
    <h1 class="inline-block text-balance bg-gradient-to-tr from-background to-white bg-clip-text text-center font-titles text-5xl font-medium uppercase text-transparent lg:text-7xl">
