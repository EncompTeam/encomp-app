  ...
  <div class="mt-32 flex flex-col items-center gap-6">
    ...
    <div class="flex flex-wrap items-center justify-center gap-20 opacity-30 grayscale md:flex-row lg:px-80">
      ...
      <NuxtLink to="https://allworkservicos.com/" external target="_blank">
        <img src="/sponsors/allwork.png" class="h-auto w-32" title="All Work Serviços">
      </NuxtLink>

      <NuxtLink to="https://www.hqcomunicacaovisual.com.br/" external target="_blank">
        <img src="/sponsors/highquality.png" class="h-auto w-48" title="High Quality - Comunicação Visual">
      </NuxtLink>

      <NuxtLink to="https://www.radiokairos.com.br/" external target="_blank">
        <img src="/sponsors/kairos.svg" class="h-auto w-24" title="Rádio Kairos - A Rádio da Família">
      </NuxtLink>
      ...
      <NuxtLink to="https://tconline.com.br/" external target="_blank">
        <img src="/sponsors/tribuna-do-cricare.png" class="h-auto w-32" title="Tribuna do Cricaré">
      </NuxtLink>
